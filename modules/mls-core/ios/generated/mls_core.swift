...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_mls_core_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_mls_core_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureMlsCoreInitialized()
...
public struct DeviceCredentialInfo: Equatable, Hashable {
    /**
     * This device's Ed25519 credential public key.
     */
    public var credentialPublicKey: Data
    /**
     ...
     */
    public var crossSignature: Data
...
#if compiler(>=6)
extension DeviceCredentialInfo: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeDeviceCredentialInfo: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> DeviceCredentialInfo {
        return
            try DeviceCredentialInfo(
                credentialPublicKey: FfiConverterData.read(from: &buf), 
                crossSignature: FfiConverterData.read(from: &buf)
        )
    }

    public static func write(_ value: DeviceCredentialInfo, into buf: inout [UInt8]) {
        FfiConverterData.write(value.credentialPublicKey, into: &buf)
        FfiConverterData.write(value.crossSignature, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeDeviceCredentialInfo_lift(_ buf: RustBuffer) throws -> DeviceCredentialInfo {
    return try FfiConverterTypeDeviceCredentialInfo.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeDeviceCredentialInfo_lower(_ value: DeviceCredentialInfo) -> RustBuffer {
    return FfiConverterTypeDeviceCredentialInfo.lower(value)
}
...
#if compiler(>=6)
extension IdentityKeyInfo: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeIdentityKeyInfo: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> IdentityKeyInfo {
        return
            try IdentityKeyInfo(
    ...
    public static func write(_ value: IdentityKeyInfo, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeIdentityKeyInfo_lift(_ buf: RustBuffer) throws -> IdentityKeyInfo {
    return try FfiConverterTypeIdentityKeyInfo.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeIdentityKeyInfo_lower(_ value: IdentityKeyInfo) -> RustBuffer {
    return FfiConverterTypeIdentityKeyInfo.lower(value)
}
 ...
 */
public 
enum MlsCoreError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
...
#if compiler(>=6)
extension MlsCoreError: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMlsCoreError: FfiConverterRustBuffer {
    typealias SwiftType = MlsCoreError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MlsCoreError {
        ...
        case 1: return .StorageNotInitialized
        case 2: return .Storage
        case 3: return .KeyGeneration
    ...
    public static func write(_ value: MlsCoreError, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMlsCoreError_lift(_ buf: RustBuffer) throws -> MlsCoreError {
    return try FfiConverterTypeMlsCoreError.lift(buf)
}
 ...
 */
public func generateDeviceCredential()throws  -> DeviceCredentialInfo  {
    return try  FfiConverterTypeDeviceCredentialInfo_lift(try rustCallWithError(FfiConverterTypeMlsCoreError_lift) {
        uniffiCallStatus in
    uniffi_mls_core_fn_func_generate_device_credential(uniffiCallStatus
    )
})
}
/**
 ...
 */
public func generateIdentityKey()throws  -> IdentityKeyInfo  {
    return try  FfiConverterTypeIdentityKeyInfo_lift(try rustCallWithError(FfiConverterTypeMlsCoreError_lift) {
        uniffiCallStatus in
    uniffi_mls_core_fn_func_generate_identity_key(uniffiCallStatus
    )
})
}
/**
 ...
 */
public func generateKeyPackages(count: UInt32)throws  -> [Data]  {
    return try  FfiConverterSequenceData.lift(try rustCallWithError(FfiConverterTypeMlsCoreError_lift) {
        uniffiCallStatus in
    uniffi_mls_core_fn_func_generate_key_packages(
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_mls_core_uniffi_contract_version()
    ...
    if (uniffi_mls_core_checksum_func_generate_identity_key() != 39810) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureMlsCoreInitialized() {
